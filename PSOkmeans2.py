# -*- coding: utf-8 -*-
"""
Created on Sun Jun 30 21:07:54 2019
...
best_cens, labels = PSOcenters(alldata_tsne, n_clusters, n_particle, kmax)
alldata_kmeans = KMeans(n_clusters=3, init=best_cens, n_init=1).fit(alldata_tsne)#n_init=1默认是10 必须改成1
plt.scatter(best_cens[:,0],best_cens[:,1], s=150, c='black')
plt.show()
